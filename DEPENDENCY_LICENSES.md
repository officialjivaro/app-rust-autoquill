...
Generated from `cargo metadata --locked` for AutoQuill's complete target-specific dependency graph.
This inventory records package-declared SPDX expressions; consult each package source for full terms.
...
| i-slint-backend-linuxkms | 1.17.1 | GPL-3.0-only OR LicenseRef-Slint-Royalty-free-2.0 OR LicenseRef-Slint-Software-3.0 |
